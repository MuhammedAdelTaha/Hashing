...
public class NSquareSpaceHash {
    ...
    // Array list of hash functions used in insertions (storing them for search
    // purpose)
     ...
     * Return an integer represents the index of the input key in the hash table
     * using this h matrix
     */
    ...
    /**
     * Takes a key and gets its appropriate hash function and index that gets a hash
     * index that does not cause collision
     */
    ...
    /**
     * Takes a key to be inserted and update tha hash table and tha array list of
     * used hash functions accordingly
     */
    ...
    /**
     * We do this growing when the number of inserted keys is greater than the size
     * of the hash table
     */
    private void grow() {
    ...
    /**
     * Takes an array list of elements and a key to be deleted from this list and
     * returns the list after deletion
     */
